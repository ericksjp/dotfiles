return {
    ...
    --             keymap = {
    --                 editor = {
    --                     ["<C-u>"] = { "toggle" }, -- Open opencode. Close if opened
    --                     ["<leader>ii"] = { "open_input" }, -- Opens and focuses on input window on insert mode
    --                     ["<leader>iI"] = { "open_input_new_session" }, -- Opens and focuses on input window on insert mode. Creates a new session
    --                     ["<leader>io"] = { "open_output" }, -- Opens and focuses on output window
    --                     ["<leader>it"] = { "toggle_focus" }, -- Toggle focus between opencode and last window
    --                     ["<leader>iT"] = { "timeline" }, -- Display timeline picker to navigate/undo/redo/fork messages
    --                     -- ["<C-d>"] = { "close" }, -- Close UI windows
    --                     ["<leader>is"] = { "select_session" }, -- Select and load a opencode session
    --                     ["<leader>iR"] = { "rename_session" }, -- Rename current session
    --                     ["<leader>ip"] = { "configure_provider" }, -- Quick provider and model switch from predefined list
    --                     ["<leader>iV"] = { "configure_variant" }, -- Switch model variant for the current model
    --                     ["<leader>iy"] = { "add_visual_selection", mode = { "v" } },
    --                     ["<leader>iz"] = { "toggle_zoom" }, -- Zoom in/out on the Opencode windows
    --                     ["<leader>iv"] = { "paste_image" }, -- Paste image from clipboard into current session
    --                     ["<leader>id"] = { "diff_open" }, -- Opens a diff tab of a modified file since the last opencode prompt
    --                     ["<leader>i]"] = { "diff_next" }, -- Navigate to next file diff
    --                     ["<leader>i["] = { "diff_prev" }, -- Navigate to previous file diff
    --                     ["<leader>ic"] = { "diff_close" }, -- Close diff view tab and return to normal editing
    --                     ["<leader>ira"] = { "diff_revert_all_last_prompt" }, -- Revert all file changes since the last opencode prompt
    --                     ["<leader>irt"] = { "diff_revert_this_last_prompt" }, -- Revert current file changes since the last opencode prompt
    --                     ["<leader>irA"] = { "diff_revert_all" }, -- Revert all file changes since the last opencode session
    --                     ["<leader>irT"] = { "diff_revert_this" }, -- Revert current file changes since the last opencode session
    --                     ["<leader>irr"] = { "diff_restore_snapshot_file" }, -- Restore a file to a restore point
    --                     ["<leader>irR"] = { "diff_restore_snapshot_all" }, -- Restore all files to a restore point
    --                     ["<leader>ix"] = { "swap_position" }, -- Swap Opencode pane left/right
    --                     ["<leader>itt"] = { "toggle_tool_output" }, -- Toggle tools output (diffs, cmd output, etc.)
    --                     ["<leader>itr"] = { "toggle_reasoning_output" }, -- Toggle reasoning output (thinking steps)
    --                     ["<leader>iq"] = { "quick_chat", mode = { "n" } }, -- Open quick chat input with selection context in visual mode or current line context in normal mode
    --                     ["q"] = { "quick_chat", mode = { "v", "x" } }, -- Open quick chat input with selection context in visual mode or current line context in normal mode
    --                 },
    --                 input_window = {
    --                     ["<C-j>"] = { "submit_input_prompt", mode = { "n", "i" } }, -- Submit prompt (normal mode and insert mode)
    --                     ["<esc>"] = nil,
    ...
    --                     ["<C- >"] = { "switch_mode", mode = "n" }, -- Switch between modes (build/plan)
